...
-- \COPY tmp (crn, subject, course_num, type, title, description, capacity, enrolled, remaining, year, term_id) FROM 'data/fall-2020/course.csv' DELIMITER ',' CSV;
-- INSERT INTO course(crn, subject, course_num, type, title, description, capacity, enrolled, remaining, year, term_id)
-- SELECT (crn, subject, course_num, type, title, description, capacity, enrolled, remaining, year, term_id) FROM tmp;
-- DROP TABLE tmp;
